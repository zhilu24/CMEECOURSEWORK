...
model_path = "esm_finetuned_model"
...
# Group by strain_id and split into train/validation/test sets (80%/10%/10%)
...
# Run predictions
r2_train, rmse_train = predict_strain_level(train_dataset, title="Training")
...
# Final summary
print("\n===== Summary =====")
print(f"Training R²:   {r2_train:.4f} | RMSE: {rmse_train:.2f}")
